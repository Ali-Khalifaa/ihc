...
class InterviewResultController extends Controller
{
    ...
    {
        $result =InterviewResult::with(['interview','course','interviewFile'])->findOrFail($id);
     ...
     */
    public function getInterviewResultByLeadId($id)
    {
        $interviews =Interview::where('lead_id',$id)->first();
