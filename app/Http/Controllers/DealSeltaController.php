...
class DealSeltaController extends Controller
{
    /**
...
//        }
        ...
        if($request->interview_cost)
        {
            $request_data['interview_cost'] = $request->interview_cost;
        }else{
            $request_data['interview_cost'] = 0;
        }


        $request_data['selta'] = 1;

        $deal = DealInterview::create($request_data);
    ...
    public function getIndividualDealSelta()
    {
        $leads = Lead::where([
            ['add_selta',1],
            ['black_list',0],
    ...
    public function getDealSeltaByEmployeeId($id)
    {
        $leads = Lead::where([
            ['add_selta',1],
            ['employee_id',$id],
